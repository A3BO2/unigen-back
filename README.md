...
MySQL 워크벤치에서 아래 SQL을 실행하여 **기본 데이터베이스와 테이블**을 생성하세요.

```sql
CREATE DATABASE senior_sns;
USE senior_sns;
...
-- 테스트 유저 생성
INSERT INTO Users (nickname, is_senior) VALUES ('test_user', FALSE);
...
* **브랜치 예시:** `feature/login-suhyeon`, `feature/post-daeyoung`
